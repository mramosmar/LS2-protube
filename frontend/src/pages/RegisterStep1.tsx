...
const RegisterStep1: React.FC<RegisterStep1Props> = ({ onNext, onSwitchToLogin }) => {
  ...
  return (
    <>
      ...
      <p className="step-indicator">Pas 1 de 2</p>
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          <small className="input-hint">Mínim 3 caràcters</small>
        </div>
